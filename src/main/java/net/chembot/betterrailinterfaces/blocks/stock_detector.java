...
public class stock_detector extends Block implements ITileEntityProvider
{
...
/*
    ...
    {
        //BetterRailInterfaces.logger.warn("called getActualState, state had value: " + state.getValue(POWERED)); //seems to always match server
